...
;(function (){
  ...
  function versionIt(error, data) {    
    ...
    //         templatePoints.flat = vertices[7]
    //         templatePoints.steep = vertices[5]
    //         templatePoints.apex = apex

    //         // Move trimWidth away from bevelled edges
    //         point = new ЗD.Vector(0, (q/2 * edge) - trimWidth, 0)
    ...
    //         point = new ЗD.Vector(0, trimWidth - (q/2 * edge), 0)
    //         templatePoints.baseSouth = point // <<<<<
    //         vertices.push(point) // 10

    //         northPlane.point = point
    ...
    //         // Create gap points
    //         point = new ЗD.Vector(0, magWidth/2, 0)
    //         templatePoints.gapBaseNorth = point.clone()
    //         vertices.push(point) // 13

    //         point.z = magHeight
    //         line.point = point.clone() // for buttress points
    //         templatePoints.gapTopNorth = line.point
    //         vertices.push(point) // 14

    //         point.y = -magWidth / 2
    //         templatePoints.gapTopSouth = point.clone()
    //         vertices.push(point) // 15

    //         point.z = 0
    //         templatePoints.gapBaseSouth = point.clone()
    //         vertices.push(point) // 16

    //         // Create buttress points
    ...
    //         northPlane.point = templatePoints.gapBaseNorth
    //         point = northPlane.intersectsLine(line)
    //         templatePoints.northRidgePoint = point
    //         vertices.push(point) // 19

    //         northPlane.point = templatePoints.gapBaseSouth
    //         point = northPlane.intersectsLine(line)
    //         templatePoints.southRidgePoint = point
    //         vertices.push(point) // 20
    //       }
    ...
    //     function createFacesForMagnetSupport() {
    //       normal = [1, 0, 0]
    //       faceIndices.push([14, 13, 8])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 8, 18])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 9, 12])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 12, 19])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 19, 20])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 20, 15])
    //       faceNormals.push(normal)
    //       faceIndices.push([15, 20, 11])
    //       faceNormals.push(normal)
    //       faceIndices.push([15, 11, 10])
    //       faceNormals.push(normal)
    //       faceIndices.push([15, 10, 16])
    //       faceNormals.push(normal)

    //       normal = [-1, 0, 0]
    //       faceIndices.push([14, 8, 13])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 18, 8])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 12, 9])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 19, 12])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 20, 19])
    //       faceNormals.push(normal)
    //       faceIndices.push([14, 15, 20])
    //       faceNormals.push(normal)
    //       faceIndices.push([15, 11, 20])
    //       faceNormals.push(normal)
    //       faceIndices.push([15, 10, 11])
    //       faceNormals.push(normal)
    //       faceIndices.push([15, 16, 10])
    //       faceNormals.push(normal)
    //     }
