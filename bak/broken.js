      ...
      function createVertices() {
        ...
        function addMagnetSupport() {
          ...
          function createSupportTemplate() {
            ...
            northPlane.point = point
            point = northPlane.intersectsLine(line)
            templatePoints.ridgeNorth = temp = point.clone()
            vertices.push(temp) // 14

            point.y = -point.y
            northPlane.point = point
            point = northPlane.intersectsLine(line)
            templatePoints.ridgeSouth = temp = point.clone()
            ...
            point.y = -point.y // = + magWidth/2
            templatePoints.gapTopNorth = point.clone()
